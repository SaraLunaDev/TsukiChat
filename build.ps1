...
Copy-Item "background.js" "build/chrome/"
Copy-Item "twitch_iframe_helper.js" "build/chrome/"
...
$chromeZip = "build/TsukiChat_Chrome_v3.0.1.zip"
...
$firefoxZip = "build/TsukiChat_Firefox_v3.0.1.zip"
